		...
		<div className="lg:px-16">
			...
			<section className="grid gap-4 text-gray-700">
				...
				<form className="grid gap-6">
					...
					<div className="flex items-center  gap-3 justify-start w-1/2">
						...
						<button className="px-3 py-2  bg-blue-600 border text-white font-semibold  rounded hover:bg-blue-700 hover:scale-105 transition-transform ease-in-out duration-50">
							Enregistrer
						</button>
					</div>
				</form>
